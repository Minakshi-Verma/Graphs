#UPDATED SOCIAL.PY WITH STRETCH QUESTIONS ANSWERED
#Here's our new and improved social network file - now with a sort-of linear way to populate the graph! 
# A nice illustration of why we care if a network if sparsely or densely connected.
import random
import time
